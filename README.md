![Hero Image](https://raw.githubusercontent.com/ValiceAn/Portfolio-/main/cvetea.jpg)
---
...
| **Dynamic Fractals** | (https://valicean.github.io/Dynamic-Fractals/) | Interactive fractal generator where users can create and explore live fractal patterns. |
| **Branching Connections** | (https://valicean.github.io/Branching-Connections/) | Interactive fractal tree visualization for managing and exploring personal contacts with significance levels, roles, and statuses. |
...
| **Markov_chains** | (https://ValiceAn.github.io/Markov_chains/) | A Snake game where the snake learns to play using Markov chains, adapting its moves probabilistically based on previous successes. | 
| **game_theory** | (https://ValiceAn.github.io/game_theory/) | Interactive game theory simulations illustrating strategies, Nash equilibria, and decision-making in classic games like Prisoner’s Dilemma and Hawk-Dove. | 
